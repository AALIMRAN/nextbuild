...
function nextbuild_scripts() {
	...
	wp_enqueue_style( 'prettyPhoto', get_theme_file_uri( 'asset/css/owl.carousel.min.css' ) );
	...
	wp_enqueue_script( 'nextbuild-owl.carousel', get_theme_file_uri( 'asset/js/owl.carousel.min.js' ), array( 'jquery' ), '1.0.0', true );
	...
	wp_enqueue_script( 'nextbuild-slider', get_theme_file_uri( 'asset/js/slide.js' ), array( 'jquery' ), '1.0.0', true );
