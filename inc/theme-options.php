<?php
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'           =>   array(
            array(
                'title' =>  esc_html__('Website Logo', 'nextbuild'),
                'id'    =>  'nextbuild-logo',
                'type'  =>  'media',
                'desc'  =>  esc_html__('Upload Your Website Logo', 'nextbuild'),
                'default'   =>  array(
                    'url'   =>  get_template_directory_uri() . '/asset/images/logo.png',
                ),
            ),
            array(
                'title' =>  esc_html__('Preloader Image', 'nextbuild'),
                'id'    =>  'nextbuild-preloader',
                'type'  =>  'media',
                'desc'  =>  esc_html__('Upload Your Preloader Image', 'nextbuild'),
                'default'   =>  array(
                    'url'   =>  get_template_directory_uri() . '/asset/images/load.gif',
                ),
            ),
        ),
    ));
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'           =>   array(
            array(
                'title' =>  esc_html__('Copyright Text', 'nextbuild'),
                'id'    =>  'copyrighttext',
                'type'  =>  'editor',
