...
add_action( 'tgmpa_register', 'nextbuild_register_required_plugins' );
 ...
 */
function nextbuild_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'nextbuild',                 // Unique ID for hashing notices for multiple instances of TGMPA.
